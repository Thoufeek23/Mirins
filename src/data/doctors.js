...
export const allDoctors = [
  {
    ...
    bio: 'Dr. Irshath Nasreen is a board-certified cardiologist with over 15 years of experience. She completed her residency at Mount Sinai Hospital and is a fellow of the American College of Cardiology. Her research in preventative cardiology has been published in several prestigious medical journals.',
  ...
  },
  {
    ...
    bio: 'Dr. Bala Saravanan is a leading orthopedic surgeon specializing in sports medicine and joint replacement. He is the head team physician for the city\'s professional soccer team and is renowned for his expertise in ACL reconstruction and robotic-assisted knee replacement.',
  ...
  // ... (the rest of your doctors from the array) ...
  {
    ...
    bio: 'Dr. Haja Mohaideen is a beloved pediatrician known for her gentle demeanor and thorough approach. She has a special interest in childhood nutrition and developmental milestones, ensuring every child gets the best possible start in life.',
  ...
  },
  {
    ...
    bio: 'Dr. Mohamed Azeem specializes in treating complex neurological conditions, including epilepsy, Parkinson\'s disease, and stroke. He is actively involved in clinical trials for new migraine treatments.',
  ...
  },
  {
    ...
    bio: 'Dr. Humaira Safreen is a medical oncologist with a focus on breast and lung cancer. She leads the hospital\'s survivorship program and is a strong proponent of integrating holistic wellness with traditional cancer therapies.',
  ...
  },
  {
    ...
    bio: 'Dr. Kishore Kumar is an interventional cardiologist known for his skill in advanced, non-surgical procedures. He believes in empowering patients with knowledge to make informed decisions about their lifestyle and treatment.',
